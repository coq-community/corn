...
apply projT2.
cut
 (Derivative_I_n Hab' 1 F
    (PartInt (ProjT1 (Diffble_I_n_imp_deriv_n 1 F diffFn)))).
2: apply projT2.
intro H.
elim H; intros f' H0 H1.
...
generalize
 (H2 (scs_elem _ _ x) (scs_prf _ _ x) (scs_prf _ _ x) (scs_prf _ _ x)).
intro H0.
...
intro H4.
cut
 (included (Compact (less_leEq _ _ _ Hab')) (Dom (n_deriv_I _ _ _ _ _ H3))).
intro H5.
