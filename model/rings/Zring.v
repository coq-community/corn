...
Definition Z_is_CRing :=
  Build_is_CRing Z_as_CAbGroup 1%Z Zmult_is_bin_fun Zmult_is_assoc
    Z_mul_is_CMonoid Zmult_is_commut Z_mult_plus_is_dist ONE_neq_O.


Definition Z_as_CRing :=
  Build_CRing Z_as_CAbGroup 1%Z Zmult_is_bin_fun Z_is_CRing. 
