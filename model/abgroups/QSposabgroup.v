...
(** *Example of an abelian group: <$\mathbb{Q}^{+}$ #Q<SUP>+</SUP>#,$(x,y) \mapsto xy/2$ #(x,y) &#x21A6; xy/2#>
*)
...
Definition Qpos_multdiv2_as_CAbGroup :=
  Build_CAbGroup Qpos_multdiv2_as_CGroup Qpos_multdiv2_is_CAbGroup.
