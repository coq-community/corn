...
Lemma map_pres_length :
 forall (A B : Set) (l : list A) (f : A -> B), length l = length (map f l).
intros.
...
Definition map2 (F : PartIR) (l : list IR)
  (H : forall y : IR, member y l -> Dom F y) : list IR.
intros.
induction  l as [| a l Hrecl].
apply nil.
apply cons.
...
Lemma map2_wd :
 forall (F : PartIR) (l : list IR) H H' (x : IR),
...
Lemma map2_pres_member :
 forall (F : PartIR) (x : IR) Hx l H,
...
Lemma maxlist_greater :
 forall (l : list IR) (x : IR), member x l -> x[<=]maxlist l.
intros l x H.
induction  l as [| a l Hrecl].
...
Lemma maxlist_leEq_eps :
 forall l : list IR,
 {x : IR | member x l} ->
 forall e : IR, Zero[<]e -> {x : IR | member x l | maxlist l[-]e[<=]x}.
...
Lemma maxlist_less :
 forall (x : IR) (l : list IR),
 0 < length l -> (forall y : IR, member y l -> y[<]x) -> maxlist l[<]x.
simple induction l.
...
Lemma maxlist_leEq :
 forall (y : IR) (l : list IR),
 0 < length l -> (forall x : IR, member x l -> x[<=]y) -> maxlist l[<=]y.
simple induction l.
simpl in |- *; intros; elimtype False; inversion H.
clear l.
do 3 intro.
...
Lemma minlist_smaller :
 forall (l : list IR) (x : IR), member x l -> minlist l[<=]x.
intros l x H.
induction  l as [| a l Hrecl].
elimtype CFalse; assumption.
simpl in |- *.
...
Lemma minlist_leEq_eps :
 forall l : list IR,
 {x : IR | member x l} ->
 forall e : IR, Zero[<]e -> {x : IR | member x l | x[<=]minlist l[+]e}.
intro l; induction  l as [| a l Hrecl].
 intro H; simpl in H; inversion H; rename X into H0; inversion H0.
clear Hrecl.
...
Lemma less_minlist :
 forall (x : IR) (l : list IR),
 0 < length l -> (forall y : IR, member y l -> x[<]y) -> x[<]minlist l.
simple induction l.
simpl in |- *; intros; elimtype False; inversion H.
clear l.
do 2 intro. intro H.
