...
Proof.
 ...
 cut
  {N : nat |
  forall m : nat, N <= m -> AbsSmall (e [/]ThreeNZ) (CS_seq IR g m[-]Lim g)}.
 intro H6.
 red in H5.
 cut
  {N : nat |
  forall m : nat, N <= m -> AbsSmall (e [/]ThreeNZ) (CS_seq IR h m[-]Lim h)}.
 intro H7.
 case H6.
 intro N1.
 intro H8.
...
Proof.
 ...
 apply
  leEq_wdr
   with
     (y := inj_Q IR (CS_seq Q_as_COrdField h n[-]CS_seq Q_as_COrdField g n)).
 apply inj_Q_leEq.
 apply H3.
 assumption.
 apply inj_Q_minus.
...
Proof.
 ...
 apply
  leEq_wdr
   with
     (y := inj_Q IR (CS_seq Q_as_COrdField h n)[-]
...
Proof.
 ...
 cut
  {N : nat |
  forall m : nat,
  N <= m -> AbsSmall ((Lim g[-]y) [/]ThreeNZ) (CS_seq IR g m[-]y)}.
 intro H2.
 case H2.
 intro N1.
 intro H3.
 ...
 cut
  {N : nat |
  forall m : nat,
  N <= m -> AbsSmall ((Lim g[-]y) [/]ThreeNZ) (CS_seq IR g m[-]Lim g)}.
 intro H5.
 case H5.
 intro N2.
 intro H6.
 ...
 cut
  {N : nat |
  forall m : nat,
  N <= m -> AbsSmall ((y[-]Lim g) [/]ThreeNZ) (CS_seq IR g m[-]y)}.
 intro H2.
 case H2.
 intro N1.
 intro H3.
 ...
 cut
  {N : nat |
  forall m : nat,
  N <= m -> AbsSmall ((y[-]Lim g) [/]ThreeNZ) (CS_seq IR g m[-]Lim g)}.
 intro H5.
 case H5.
 intro N2.
 intros.
...
Proof.
 ...
 cut
  {N : nat |
  forall m : nat,
  N <= m -> AbsSmall (e [/]TwoNZ) (CS_seq IR g m[-]CS_seq IR h m)}.
 intro H3.
 cut (SeqLimit (CS_seq IR g) (Lim g)).
 intro H4.
 red in H4.
 cut
  {N : nat |
  forall m : nat, N <= m -> AbsSmall (e [/]TwoNZ) (CS_seq IR g m[-]Lim g)}.
 intro H5.
 case H3.
 intro N1.
 intro H6.
...
Proof.
 ...
 cut
  {N : nat |
  forall m : nat, N <= m -> AbsSmall (e [/]TwoNZ) (CS_seq IR h m[-]Lim h)}.
 intro H4.
 case H3.
 intro N1.
 intro H5.
...
Proof.
 ...
 apply
  Eq_alt_2_2
   with
     (x := Build_CauchySeq IR (fun m : nat => inj_Q IR (CS_seq _ g m))
             (inj_Q_Cauchy IR g))
     (y := Build_CauchySeq IR
             (fun m : nat => inj_Q IR (CS_seq Q_as_COrdField h m))
             (inj_Q_Cauchy IR h)).                       
 intros.
 simpl in |- *.
...
Proof.
 ...
 cut
  ...
  AbsSmall (inj_Q IR e)
    (CS_seq IR
       (Build_CauchySeq IR
          (fun m : nat => inj_Q IR (CS_seq Q_as_COrdField g m))
          (inj_Q_Cauchy IR g)) m[-]
     CS_seq IR
       (Build_CauchySeq IR
          (fun m : nat => inj_Q IR (CS_seq Q_as_COrdField h m))
 ...
 cut
  (AbsSmall (inj_Q IR e)
     (CS_seq IR
        (Build_CauchySeq IR
           (fun m0 : nat => inj_Q IR (CS_seq Q_as_COrdField g m0))
           (inj_Q_Cauchy IR g)) m[-]
      CS_seq IR
        (Build_CauchySeq IR
           (fun m0 : nat => inj_Q IR (CS_seq Q_as_COrdField h m0))
           (inj_Q_Cauchy IR h)) m)).
 intro.
 cut
  (AbsSmall (inj_Q IR e)
     (inj_Q IR (CS_seq Q_as_COrdField g m[-]CS_seq Q_as_COrdField h m))).
 intro H5.
...
Proof.
 ...
 apply
  Eq_alt_2_2
   with
     (x := Build_CauchySeq Q_as_COrdField (fun m : nat => G IR (x[+]y) m)
             (CS_seq_G IR (x[+]y)))
     (y := Build_CauchySeq Q_as_COrdField
             (fun m : nat => G IR x m[+]G IR y m)
             (CS_seq_plus Q_as_COrdField (fun n : nat => G IR x n)
                (fun n : nat => G IR y n) (CS_seq_G IR x) (
                CS_seq_G IR y))).
 intros e H.
 ...
 apply
  eq_transitive_unfolded
   with (y := inj_Q IR (e [/]ThreeNZ[+]e [/]ThreeNZ[+]e [/]ThreeNZ)).
 apply
  eq_transitive_unfolded
   with
 ...
 apply
  eq_transitive_unfolded
   with (y := inj_Q IR (G IR (x[+]y) m)[-]inj_Q IR (G IR x m[+]G IR y m)).
 apply cg_minus_wd.
 apply eq_reflexive_unfolded.
 apply eq_symmetric_unfolded.
 apply inj_Q_plus.
...
Proof.
 ...
 change
   (Cauchy_prop
      (fun n : nat =>
       inj_Q R2 (CS_seq Q_as_COrdField (G_as_CauchySeq R1 x) n))) 
  in |- *.
 apply inj_Q_Cauchy.
Qed.
...
Proof.
 ...
 change
   ((Build_CauchySeq R2
       (fun m : nat =>
        inj_Q R2 (CS_seq Q_as_COrdField (G_as_CauchySeq R2 y) m))
       (CS_seq_inj_Q_G R2 y)
     :R_COrdField R2)[=]
    Build_CauchySeq R2
      (fun n : nat =>
 ...
 change
   ((Build_CauchySeq R2
       (fun m : nat =>
        inj_Q R2 (CS_seq Q_as_COrdField (G_as_CauchySeq R2 y) m))
       (inj_Q_Cauchy R2 (G_as_CauchySeq R2 y))
     :R_COrdField R2)[=]
    Build_CauchySeq R2
      (fun n : nat =>
       inj_Q R2 (CS_seq Q_as_COrdField (G_as_CauchySeq R1 (g21 y)) n))
      (inj_Q_Cauchy R2 (G_as_CauchySeq R1 (g21 y)))) 
  in |- *.
 apply
  inj_seq_well_def
   with (g := G_as_CauchySeq R2 y) (h := G_as_CauchySeq R1 (g21 y)).
 
 apply inj_Q_one_one with (IR := R1).
 change
   ((Build_CauchySeq R1 (fun m : nat => inj_Q R1 (G R2 y m))
       (image_Cauchy21 y)
     :R_COrdField R1)[=]
    Build_CauchySeq R1 (fun n : nat => inj_Q R1 (G R1 (g21 y) n))
      (CS_seq_inj_Q_G R1 (g21 y))) in |- *.
 change
   ((image_G_as_CauchySeq21 y:R_COrdField R1)[=]
    inj_Q_G_as_CauchySeq R1 (g21 y)) in |- *.
...
Proof.
 ...
 intros x y H.
 case
  (ap_imp_less R2 (Lim (image_G_as_CauchySeq12 x))
     (Lim (image_G_as_CauchySeq12 y)) H).
 intro.
 apply less_imp_ap.
 ...
 change
   ((Build_CauchySeq R1
       (fun m : nat =>
        inj_Q R1 (CS_seq Q_as_COrdField (G_as_CauchySeq R1 x) m))
       (inj_Q_Cauchy R1 (G_as_CauchySeq R1 x))
     :R_COrdField R1)[<]
    Build_CauchySeq R1
      (fun n : nat =>
 ...
 change
   ((image_G_as_CauchySeq12 x:R_COrdField R2)[<]
 ...
 change
   ((Build_CauchySeq R1
       (fun m : nat =>
        inj_Q R1 (CS_seq Q_as_COrdField (G_as_CauchySeq R1 y) m))
       (inj_Q_Cauchy R1 (G_as_CauchySeq R1 y))
     :R_COrdField R1)[<]
    Build_CauchySeq R1
      (fun n : nat =>
 ...
 apply less_inj_seq with (IR := R2).
 change
   ((image_G_as_CauchySeq12 y:R_COrdField R2)[<]
...
Proof.
 ...
 change
   ((Build_CauchySeq R2
       (fun m : nat =>
        inj_Q R2 (CS_seq Q_as_COrdField (G_as_CauchySeq R1 x) m))
       (inj_Q_Cauchy R2 (G_as_CauchySeq R1 x))
     :R_COrdField R2)[<]
    Build_CauchySeq R2
      (fun n : nat =>
 ...
 change
   ((inj_Q_G_as_CauchySeq R1 x:R_COrdField R1)[<]
...
Proof.
 ...
 apply
  eq_transitive_unfolded
   with
     (S := R_COrdField R2:CSetoid)
     (y := Build_CauchySeq R2 (fun m : nat => inj_Q R2 (G R1 x m[+]G R1 y m))
             (inj_Q_Cauchy R2
                (Build_CauchySeq Q_as_COrdField
                   (fun m : nat => G R1 x m[+]G R1 y m)
                   (CS_seq_plus Q_as_COrdField (fun n : nat => G R1 x n)
                      (fun n : nat => G R1 y n) (CS_seq_G R1 x)
                      (CS_seq_G R1 y))))
           :R_COrdField R2).
 change
   ((Build_CauchySeq R2
       ...
       (inj_Q_Cauchy R2 (G_as_CauchySeq R1 (x[+]y)))
     :R_COrdField R2)[=]
    Build_CauchySeq R2
      (fun m : nat =>
       inj_Q R2
         (CS_seq Q_as_COrdField
            (Build_CauchySeq Q_as_COrdField
               (fun m : nat => G R1 x m[+]G R1 y m)
               (CS_seq_plus Q_as_COrdField (fun n : nat => G R1 x n)
                  (fun n : nat => G R1 y n) (CS_seq_G R1 x) (
 ...
 apply
  Eq_alt_2_2
   with
     (x := Build_CauchySeq R2 (fun m : nat => inj_Q R2 (G R1 x m[+]G R1 y m))
             (inj_Q_Cauchy R2
                (Build_CauchySeq Q_as_COrdField
                   (fun m : nat => G R1 x m[+]G R1 y m)
                   (CS_seq_plus Q_as_COrdField (fun n : nat => G R1 x n)
                      ...
                      (CS_seq_G R1 y))))
           :R_COrdField R2)
     (y := Build_CauchySeq R2
             (fun m : nat => inj_Q R2 (G R1 x m)[+]inj_Q R2 (G R1 y m))
             (CS_seq_plus R2 (fun n : nat => inj_Q R2 (G R1 x n))
                (fun n : nat => inj_Q R2 (G R1 y n)) (
                image_Cauchy12 x) (image_Cauchy12 y))
           :R_COrdField R2).
 intros.
 exists 0.
 intros.
...
Proof.
   ...
   with
     ...
     (y := Build_CauchySeq R2 (fun m : nat => inj_Q R2 (G R1 x m[*]G R1 y m))
             (inj_Q_Cauchy R2
                (Build_CauchySeq Q_as_COrdField
                   (fun m : nat => G R1 x m[*]G R1 y m)
                   (CS_seq_mult Q_as_COrdField _ _
                      (CS_proof _ (G_as_CauchySeq R1 x))
                      (CS_proof _ (G_as_CauchySeq R1 y)))))
           :R_COrdField R2).
 change
   ((Build_CauchySeq R2
       (fun n : nat =>
       ...
       inj_Q R2
         (CS_seq Q_as_COrdField
            (Build_CauchySeq Q_as_COrdField
               ...
               (CS_seq_mult Q_as_COrdField _ _
                  (CS_proof _ (G_as_CauchySeq R1 x))
                  (CS_proof _ (G_as_CauchySeq R1 y)))) m))
      (inj_Q_Cauchy R2
         (Build_CauchySeq Q_as_COrdField (fun m : nat => G R1 x m[*]G R1 y m)
            (CS_seq_mult Q_as_COrdField _ _
               (CS_proof _ (G_as_CauchySeq R1 x))
 ...
 unfold G_as_CauchySeq in |- *.
 change
   ((Build_CauchySeq Q_as_COrdField (fun m : nat => G R1 (x[*]y) m)
       (CS_seq_G R1 (x[*]y))
     :R_COrdField Q_as_COrdField)[=]
    Build_CauchySeq Q_as_COrdField (fun m : nat => G R1 x m[*]G R1 y m)
     ...
     (x := Build_CauchySeq R2 (fun m : nat => inj_Q R2 (G R1 x m[*]G R1 y m))
             (inj_Q_Cauchy R2
                (Build_CauchySeq Q_as_COrdField
                   (fun m : nat => G R1 x m[*]G R1 y m)
                   (CS_seq_mult Q_as_COrdField _ _
                      (CS_proof Q_as_COrdField (G_as_CauchySeq R1 x))
                      (CS_proof Q_as_COrdField (G_as_CauchySeq R1 y))))))
     (y := Build_CauchySeq R2
             (fun m : nat => inj_Q R2 (G R1 x m)[*]inj_Q R2 (G R1 y m))
 ...
 change
   ((Build_CauchySeq R1
    ...
    Build_CauchySeq R1
      (fun n : nat =>
       inj_Q R1 (CS_seq Q_as_COrdField (G_as_CauchySeq R2 (f12 y)) n))
      (inj_Q_Cauchy R1 (G_as_CauchySeq R2 (f12 y)))) 
  in |- *.
 apply
  inj_seq_well_def
   with (g := G_as_CauchySeq R1 y) (h := G_as_CauchySeq R2 (f12 y)).
 
 apply inj_Q_one_one with (IR := R2).
 change
   ((image_G_as_CauchySeq12 y:R_COrdField R2)[=]
    inj_Q_G_as_CauchySeq R2 (f12 y)) in |- *.
...
Proof.
 ...
 intros x y H.
 case
  (ap_imp_less R1 (Lim (image_G_as_CauchySeq21 x))
     (Lim (image_G_as_CauchySeq21 y)) H).
 intro.
 apply less_imp_ap.
 ...
 change
   ((Build_CauchySeq R2
       (fun m : nat =>
        inj_Q R2 (CS_seq Q_as_COrdField (G_as_CauchySeq R2 x) m))
       (inj_Q_Cauchy R2 (G_as_CauchySeq R2 x))
     :R_COrdField R2)[<]
    Build_CauchySeq R2
      (fun n : nat =>
 ...
 apply less_inj_seq with (IR := R1).
 change
   ((image_G_as_CauchySeq21 x:R_COrdField R1)[<]
...
Proof.
 ...
 change
   ((Build_CauchySeq R1
       (fun m : nat =>
        inj_Q R1 (CS_seq Q_as_COrdField (G_as_CauchySeq R2 x) m))
       (inj_Q_Cauchy R1 (G_as_CauchySeq R2 x))
     :R_COrdField R1)[<]
    Build_CauchySeq R1
      (fun n : nat =>
       inj_Q R1 (CS_seq Q_as_COrdField (G_as_CauchySeq R2 y) n))
 ...
 apply less_inj_seq with (IR := R2). 
 change
   ((inj_Q_G_as_CauchySeq R2 x:R_COrdField R2)[<]
...
Proof.
 ...
 apply
  eq_transitive_unfolded
   with
     (S := R_COrdField R1:CSetoid)
     (y := Build_CauchySeq R1 (fun m : nat => inj_Q R1 (G R2 x m[+]G R2 y m))
             (inj_Q_Cauchy R1
                (Build_CauchySeq Q_as_COrdField
                   (fun m : nat => G R2 x m[+]G R2 y m)
                   (CS_seq_plus Q_as_COrdField (fun n : nat => G R2 x n)
                      (fun n : nat => G R2 y n) (CS_seq_G R2 x)
                      (CS_seq_G R2 y))))
           :R_COrdField R1).
 change
   ((Build_CauchySeq R1
       ...
       (inj_Q_Cauchy R1 (G_as_CauchySeq R2 (x[+]y)))
     :R_COrdField R1)[=]
    Build_CauchySeq R1
      (fun m : nat =>
       inj_Q R1
 ...
 apply
  Eq_alt_2_2
   with
     (x := Build_CauchySeq R1 (fun m : nat => inj_Q R1 (G R2 x m[+]G R2 y m))
             (inj_Q_Cauchy R1
                (Build_CauchySeq Q_as_COrdField
                   (fun m : nat => G R2 x m[+]G R2 y m)
                   (CS_seq_plus Q_as_COrdField (fun n : nat => G R2 x n)
                      ...
                      (CS_seq_G R2 y))))
           :R_COrdField R1)
     (y := Build_CauchySeq R1
             (fun m : nat => inj_Q R1 (G R2 x m)[+]inj_Q R1 (G R2 y m))
             (CS_seq_plus R1 (fun n : nat => inj_Q R1 (G R2 x n))
                (fun n : nat => inj_Q R1 (G R2 y n)) (
                image_Cauchy21 x) (image_Cauchy21 y))
           :R_COrdField R1).
 intros.
 exists 0.
 intros.
...
Proof.
     ...
     (y := Build_CauchySeq R1 (fun m : nat => inj_Q R1 (G R2 x m[*]G R2 y m))
             (inj_Q_Cauchy R1
                (Build_CauchySeq Q_as_COrdField
                   (fun m : nat => G R2 x m[*]G R2 y m)
                   (CS_seq_mult Q_as_COrdField _ _
                      (CS_proof _ (G_as_CauchySeq R2 x))
                      (CS_proof _ (G_as_CauchySeq R2 y)))))
           :R_COrdField R1).
 change
   ((Build_CauchySeq R1
       (fun n : nat =>
       ...
       inj_Q R1
         (CS_seq Q_as_COrdField
            (Build_CauchySeq Q_as_COrdField
               ...
               (CS_seq_mult Q_as_COrdField _ _
                  (CS_proof _ (G_as_CauchySeq R2 x))
                  (CS_proof _ (G_as_CauchySeq R2 y)))) m))
      (inj_Q_Cauchy R1
         (Build_CauchySeq Q_as_COrdField (fun m : nat => G R2 x m[*]G R2 y m)
            (CS_seq_mult Q_as_COrdField _ _
               (CS_proof _ (G_as_CauchySeq R2 x))
 ...
 unfold G_as_CauchySeq in |- *.
 change
   ((Build_CauchySeq Q_as_COrdField (fun m : nat => G R2 (x[*]y) m)
       (CS_seq_G R2 (x[*]y))
     :R_COrdField Q_as_COrdField)[=]
    Build_CauchySeq Q_as_COrdField (fun m : nat => G R2 x m[*]G R2 y m)
   ...
   with
     (x := Build_CauchySeq R1 (fun m : nat => inj_Q R1 (G R2 x m[*]G R2 y m))
             (inj_Q_Cauchy R1
                (Build_CauchySeq Q_as_COrdField
                   (fun m : nat => G R2 x m[*]G R2 y m)
                   (CS_seq_mult Q_as_COrdField (G_as_CauchySeq R2 x)
                      (G_as_CauchySeq R2 y)
                      (CS_proof Q_as_COrdField (G_as_CauchySeq R2 x))
                      (CS_proof Q_as_COrdField (G_as_CauchySeq R2 y))))))
     (y := Build_CauchySeq R1
             (fun m : nat => inj_Q R1 (G R2 x m)[*]inj_Q R1 (G R2 y m))
             (CS_seq_mult R1 (image_G_as_CauchySeq21 x)
                (image_G_as_CauchySeq21 y)
                (CS_proof R1 (image_G_as_CauchySeq21 x))
                (CS_proof R1 (image_G_as_CauchySeq21 y)))).
 intros.
 exists 0.
 intros.
 unfold CS_seq in |- *.
